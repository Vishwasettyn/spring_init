...
import com.example.spring_init.advice.EmptyInputException;
...
public class PersonControllerTest {
    ...
    public void testAddPerson() {
        ...
        personModel.setAddress("bangalore");
    ...
    @Test
    public void testAddPersonGlobalFailure() {
        CreatePersonModel personModel = EntityBuilder.getcreatePersonModel("name", 560068);
        Mockito.when(personRepository.save(personModel.toPerson())).thenReturn(personModel.toPerson());

        Assertions.assertThrows(EmptyInputException.class, (() -> personController.addPerson(personModel)), "Person add should fail");
    }
    ...
    public void testGetPerson() {
        ...
        Person person = personController.getPerson(personModel.getName()).getFirst();
    ...
    public void testDeletePersonFailure() {
        ...
        List<Person> deleted_person = personController.getPerson(personModel.getName());
        Assertions.assertNotEquals(deleted_person.size(), 0, "Person should be deleted");
    }
